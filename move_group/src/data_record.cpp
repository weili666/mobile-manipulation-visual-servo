...
{
    ros::init(argc,argv,"move_ur5_example2");
    ros::NodeHandle nh;
    ...
    if (!kdl_tree.getChain("ur5_arm_base_link", "robotiq_85_base_link", jaco_chain))
    {
    ...
    jointStateSubscriber = nh.subscribe("/ur5/joint_states",1000,JointDataCallback);
